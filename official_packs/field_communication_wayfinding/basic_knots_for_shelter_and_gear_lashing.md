---
title: Basic Knots for Shelter and Gear Lashing
...
# Basic Knots for Shelter and Gear Lashing

## Summary

A few simple knots and a basic lashing technique are enough to join poles for a shelter frame or secure loose gear. These techniques are for general fieldcraft only - not for climbing, rescue, or any use where a failure could cause a fall or injury.
...
None of the knots or lashings described here are rated or recommended for climbing, rescue rigging, fall-arrest, lifting a person, or any other safety-critical load-bearing use - they are intended only for basic fieldcraft such as shelter framing and securing gear. For anything where a failure could cause a fall or injury, use purpose-rated equipment and proper training instead.

## Benefits

- Requires only cordage and basic poles or branches, no special tools
- Enough to build a simple shelter frame or secure loose gear
- Easy to check, redo, or adjust as conditions change
